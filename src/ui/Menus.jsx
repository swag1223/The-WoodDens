...
const Menus = ({ children }) => {
	...
	return (
		<MenusContext.Provider
			value={{ openMenuId, openMenu, closeMenu, position, setPosition }}
		>
			{children}
		</MenusContext.Provider>
	);
...
const Toggle = ({ clickedMenuId }) => {
	const { openMenuId, closeMenu, openMenu, setPosition } =
	...
	const handleClick = (e) => {
		...
		openMenuId === "" || openMenuId !== clickedMenuId
			? openMenu(clickedMenuId)
			: closeMenu();
	};
